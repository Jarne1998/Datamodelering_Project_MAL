...
SET IDENTITY_INSERT Project_MAL.Genre ON
INSERT INTO Project_MAL.Genre(genreId, mangaGenreId, animeGenreId, naamGenre)
VALUES(2, 2, 0, 'Action, Adventure, Comedy, Drama, Shounen, Military');
...
SET IDENTITY_INSERT Project_MAL.Genre ON
INSERT INTO Project_MAL.Genre(genreId, mangaGenreId, animeGenreId, naamGenre)
VALUES(6, 6, 0, 'Action, Adventure, Shounen, Super Power, Supernatural');

-- 7)
SET IDENTITY_INSERT Project_MAL.Genre ON
INSERT INTO Project_MAL.Genre(genreId, mangaGenreId, animeGenreId, naamGenre)
VALUES(7, 7, 0, 'Action, Demons, Historical, Shounen, Supernatural');
